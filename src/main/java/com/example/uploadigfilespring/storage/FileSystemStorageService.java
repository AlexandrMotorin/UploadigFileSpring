package com.example.uploadigfilespring.storage;
...
public class FileSystemStorageService implements StorageService{
    ...
    public void store(MultipartFile file) {
        try {
            ...
            Path originalFileName = Paths.get(Objects.requireNonNull(file.getOriginalFilename()));
    ...
    public void init() {
        try {
            ...
            throw new StorageException("Could not init exception",e);
        }
    }
